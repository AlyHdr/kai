...
class LegacyMealPlanScreen extends StatefulWidget {
  const LegacyMealPlanScreen({super.key});

  @override
  State<LegacyMealPlanScreen> createState() => _MealPlanScreenState();
}

class _MealPlanScreenState extends State<LegacyMealPlanScreen> {
